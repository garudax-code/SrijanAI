...
const TSHIRT_TRANSPARENT_IMAGE_URL = "https://res.cloudinary.com/dcqqbd2rc/image/upload/v1776448395/t-shirt-transparent-front_zuyuio.png"
const HOODIE_TRANSPARENT_IMAGE_URL = "https://res.cloudinary.com/dcqqbd2rc/image/upload/v1776448390/hoodies-transparent-front_czzmxf.png"
...
const seedProducts = async () => {
  try {
    ...
    console.log(error, "Error seeing products");
    process.exit(1)
  }
}
